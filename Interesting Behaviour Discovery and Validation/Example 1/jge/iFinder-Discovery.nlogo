...
BNF/interesting-grammar-example-1.bnf
1
0
String
...
415
custom-code
ifelse (ROBOT::COLOUR-AHEAD-GREEN?) [ ROBOT::LEFT  120  ][ ROBOT::FORWARD ]    ROBOT::FORWARD ifelse (ROBOT::COLOUR-AHEAD-WHITE?) [ ROBOT::RIGHT  90  ][ ROBOT::FORWARD ]
1
1
String
